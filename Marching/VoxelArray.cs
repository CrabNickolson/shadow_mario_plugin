...
namespace MarchingCubesProject
{
    ...
    public class VoxelArray
    {
        ...
        public float GetVoxel(float u, float v, float w)
        {
            ...
            int zi = (int)System.MathF.Floor(z);
        ...
        private static float clamp(float _x, float _min, float _max)
        {
            return System.Math.Min(System.Math.Max(_x, _min), _max);
        }

        private static int clamp(int _x, int _min, int _max)
        {
            return System.Math.Min(System.Math.Max(_x, _min), _max);
        }
